...
# -*- coding: utf-8 -*-
"""
增强版OFI+CVD数据采集脚本 (Task 1.3.1 v2)
基于Task 1.2.4的成功WebSocket+OFI实现
"""
    ...
    def __init__(self, symbols=None, run_hours=1, output_dir="data/ofi_cvd"):
        ...
        if OFI_AVAILABLE:
            for symbol in self.symbols:
                ...
                self.ofi_calculators[symbol] = RealOFICalculator(config)
        ...
        logger.info(f"初始化增强版采集器: {self.symbols}, 运行{run_hours}小时")
...
async def main():
    ...
    # 创建增强版采集器
    harvester = EnhancedOFICVDHarvester(symbols, run_hours, output_dir)
