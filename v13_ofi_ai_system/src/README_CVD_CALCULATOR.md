...
5. ✅ **Binance适配器**: 直接处理Binance `aggTrade`消息
6. ✅ **批量更新**: 高效处理成交流批量数据
7. ✅ **状态管理**: reset/get_state 可观测和重置
8. ✅ **边界处理**: 自动过滤异常数据（负量/NaN/Inf）
...
if price > last_price:
    ...
    direction = last_direction  # 沿用上一笔方向（通过_last_side记忆）
```
