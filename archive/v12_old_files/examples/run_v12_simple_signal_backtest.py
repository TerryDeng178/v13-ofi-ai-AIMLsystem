...
def generate_simple_signal(row, signal_quality_threshold=0.35, ai_confidence_threshold=0.55, signal_strength_threshold=0.15):
    ...
    Args:
        row: 数据行
        signal_quality_threshold: 信号质量阈值
...
def run_simple_signal_backtest():
    ...
    for i, row in backtest_data.iterrows():
        ...
        try:
            ...
            if signal:
                ...
                # 验证信号
                if validation_framework.validate_signal(signal, current_position):
                    signals_filtered += 1
    ...
    report = {
        ...
        'backtest_type': 'V12_Simple_Signal_Backtest',
        'parameters': {
    ...
    report_file = f"backtest_results/v12_simple_signal_backtest_{timestamp}.json"
