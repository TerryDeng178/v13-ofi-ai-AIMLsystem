...
def test_simple_advanced_trading_system():
    """测试简化高级交易系统"""
    # 币安测试网API配置
    ...
    logger.info("开始测试币安V10简化高级交易系统...")
    
    trading_system = None
    try:
        # 创建简化高级交易系统
        trading_system = BinanceV10SimpleAdvanced(API_KEY, SECRET_KEY, SYMBOL)
        
        # 启动系统
        trading_system.start()
        logger.info("简化高级交易系统启动成功")
...
if __name__ == "__main__":
    test_simple_advanced_trading_system()
